...
@software: PyCharm
@file: SparkSqlJoin.py
@time: 2017/12/5 18:16
...
if __name__ == '__main__':
    ...
    df2 = sc.parallelize([Row(name='Alice', age=15, height=80), Row(name='guanyu', age=25, height=80),
                          Row(name='liubei', age=56, height=80)]).toDF()
    ...
    print(".................................................... df.registerTempTable()  .......................")
    # 代码运行到此出错了 ...... seed
    dataset = sqlContext.range(0, 100).select((int("id") % 3).alias("key"))
